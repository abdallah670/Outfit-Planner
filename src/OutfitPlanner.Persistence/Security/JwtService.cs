...
public class JwtService : IJWTService
{
    ...
    public JwtService(UserManager<User> userManager, SignInManager<User> signInManager, IOptions<JwtSettings> jwtSettings)
    {
    ...
    public async Task<AuthResponse> Login(AuthRequest request)
    {
        ...
        user.RefreshTokenExpiration = DateTime.UtcNow.AddDays(7); // Hardcoded for now, can be moved to settings
