...
[Authorize]
public class ValidationPollController : ControllerBase
{
    private readonly IMediator _mediator;
    private readonly ILogger<ValidationPollController> _logger;

    public ValidationPollController(IMediator mediator, ILogger<ValidationPollController> logger)
    {
        _mediator = mediator;
        _logger = logger;
    }
