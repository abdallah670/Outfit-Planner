...
export const routes: Routes = [
  ...
  { path: 'social/profile/:userId', loadComponent: () => import('./presentation/pages/public-profile/public-profile.component').then(m => m.PublicProfileComponent), canActivate: [authGuard] },
